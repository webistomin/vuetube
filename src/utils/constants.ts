 ...
 * YouTube hosts
 */
export const DEFAULT_HOST = 'https://www.youtube.com';
 ...
 */
export const GOOGLE_ADS_URL = 'https://googleads.g.doubleclick.net';
export const GOOGLE_FONTS_URL = 'https://fonts.gstatic.com';
export const GOOGLE_URL = 'https://google.com';
export const YTIMG_URL = 'https://i.ytimg.com';
export const GSTATIC_URL = 'https://www.gstatic.com';
export const YT3_URL = 'https://yt3.ggpht.com';
